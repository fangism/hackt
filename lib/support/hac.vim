...
syn keyword	cTodo		contained TODO FIXME XXX BUG
...
syn keyword	cStructure	enum typedef
" syn keyword	cStructure	struct union
" syn keyword	cStorageClass	static register auto volatile extern const
" syn keyword	cStorageClass	inline
" syn keyword cConstant __LINE__ __FILE__ __DATE__ __TIME__
...
syn region	cDefine		start="^\s*\(%:\|#\)\s*\(include\|undef\)\>" skip="\\$" end="$" end="//"me=s-1 contains=ALLBUT,@cPreProcGroup
