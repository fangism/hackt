...
in state #STATE#, possible rules are:
	...
	defchan: optional_template_specification . DEFCHAN ID DEFINEOP base_chan_type optional_port_formal_decl_list_in_parens '{' optional_datatype_body send_body recv_body '}'  (#RULE#)
