/**
	\file "Object/expr/expr_fwd.hh"
	Forward declarations of all expression-related classes.  
	$Id: expr_fwd.hh,v 1.9 2010/09/21 00:18:15 fang Exp $
 */
...
namespace entity {
	...
	// from "Object/expr/data_expr[_base].hh"
	class data_expr;
	class bool_expr;
	class int_expr;
...
//      class loop_range_list;
	...
	// from "Object/expr/const_collection.hh"
	template <class>
	...
	// from "Object/expr/loop_meta_expr.hh"
	template <class>
	...
	// from "Object/expr/loop_nonmeta_expr.hh"
	template <class>
