/**
	\file "Object/expr/const_param_expr_list.hh"
	Classes related to constant expressions.
	NOTE: this file was spanwed from "Object/art_object_expr_const.h"
		for revision history tracking purposes.  
	$Id: const_param_expr_list.hh,v 1.20 2009/09/14 21:16:54 fang Exp $
 */
...
//	const_param_expr_list(const const_param_expr_list& pl);
	...
	ostream&
	dump_raw_from(ostream&, const size_t) const;

	ostream&
	dump_formatted(ostream&, const char*, const char*, const char*) const;
