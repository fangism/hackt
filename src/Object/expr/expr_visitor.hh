/**
	\file "Object/expr/expr_visitor.hh"
	Expression visitor interface.  
	$Id: expr_visitor.hh,v 1.8 2010/09/21 00:18:15 fang Exp $
 */
...
virtual	VISIT_PROTO(channel_probe) = 0;
...
// virtual	VISIT_PROTO(real_return_cast_expr) = 0;
