/**
	\file "Object/unroll/template_type_completion.hh"
	...
	$Id: template_type_completion.hh,v 1.2 2007/07/18 23:29:04 fang Exp $
 */
...
namespace HAC {
namespace entity {
class dynamic_param_expr_list;	// from "Object/expr/dynamic_param_expr_list.hh"
