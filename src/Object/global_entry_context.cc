...
#else
			owner = ret.get_context();	// frame and offset
...
//		STACKTRACE_INDENT_PRINT("ppid = " << ppid << endl);
		...
		const global_process_context& common(owners.front());
#else
		global_process_context common(*topfp);	// common owner
