/**
	...
	$Id: art_object_inst_ref_data.h,v 1.7.4.1 2005/06/03 21:43:51 fang Exp $
 */
 ...
 */
class datatype_instance_reference_base : public simple_instance_reference {
private:
...
protected:
	...
	explicit
	datatype_instance_reference_base(const instantiation_state& s);
