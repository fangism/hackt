/**
	...
	This file originally came from 
		...
		in a previous life.  
	$Id: instance_collection.tcc,v 1.26.2.1 2006/04/25 18:23:45 fang Exp $
	TODO: trim includes
 */
...
INSTANCE_ARRAY_TEMPLATE_SIGNATURE
__SELF_CHUNK_MAP_POOL_STATIC_INIT(EMPTY, typename, INSTANCE_ARRAY_CLASS)

INSTANCE_ARRAY_TEMPLATE_SIGNATURE
__CHUNK_MAP_POOL_ROBUST_STATIC_GET_POOL(EMPTY, typename, INSTANCE_ARRAY_CLASS)

INSTANCE_ARRAY_TEMPLATE_SIGNATURE
__CHUNK_MAP_POOL_ROBUST_OPERATOR_NEW(EMPTY, INSTANCE_ARRAY_CLASS)

INSTANCE_ARRAY_TEMPLATE_SIGNATURE
__CHUNK_MAP_POOL_ROBUST_OPERATOR_PLACEMENT_NEW(EMPTY, INSTANCE_ARRAY_CLASS)

INSTANCE_ARRAY_TEMPLATE_SIGNATURE
__CHUNK_MAP_POOL_ROBUST_OPERATOR_DELETE(EMPTY, INSTANCE_ARRAY_CLASS)
#undef	EMPTY
...
__SELF_CHUNK_MAP_POOL_STATIC_INIT(EMPTY, typename, INSTANCE_SCALAR_CLASS)

INSTANCE_SCALAR_TEMPLATE_SIGNATURE
__CHUNK_MAP_POOL_ROBUST_STATIC_GET_POOL(EMPTY, typename, INSTANCE_SCALAR_CLASS)

INSTANCE_SCALAR_TEMPLATE_SIGNATURE
__CHUNK_MAP_POOL_ROBUST_OPERATOR_NEW(EMPTY, INSTANCE_SCALAR_CLASS)

INSTANCE_SCALAR_TEMPLATE_SIGNATURE
__CHUNK_MAP_POOL_ROBUST_OPERATOR_PLACEMENT_NEW(EMPTY, INSTANCE_SCALAR_CLASS)

INSTANCE_SCALAR_TEMPLATE_SIGNATURE
__CHUNK_MAP_POOL_ROBUST_OPERATOR_DELETE(EMPTY, INSTANCE_SCALAR_CLASS)
#undef	EMPTY
#endif	// POOL_ALLOCATE_INSTANCE_COLLECTIONS
