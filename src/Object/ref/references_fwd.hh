...
// from "Object/ref/*nonmeta_instance_reference*.hh"
// note there are generic (non-meta) abstract base classes from which
// the meta-versions are derived.
// defined in "Object/ref/nonmeta_instance_reference_subtypes.hh"
