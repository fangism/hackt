/**
	...
	Method definitions for the data_reference family of objects.
 	$Id: art_object_inst_ref_data.tcc,v 1.1.2.3 2005/06/06 09:25:59 fang Exp $
 */

#ifndef	__OBJECT_ART_OBJECT_INST_REF_DATA_TCC__
#define	__OBJECT_ART_OBJECT_INST_REF_DATA_TCC__
...
DATA_REFERENCE_CLASS::data_reference() :
...
DATA_REFERENCE_CLASS::get_inst_base(void) const {
...
DATA_REFERENCE_TEMPLATE_SIGNATURE
ostream&
DATA_REFERENCE_CLASS::what(ostream& o) const {
...
DATA_REFERENCE_TEMPLATE_SIGNATURE
ostream&
DATA_REFERENCE_CLASS::dump(ostream& o) const {
...
DATA_REFERENCE_TEMPLATE_SIGNATURE
size_t
DATA_REFERENCE_CLASS::dimensions(void) const {
	return parent_type::dimensions();
}
...
DATA_REFERENCE_CLASS::make_aliases_connection_private(void) const {
...
DATA_REFERENCE_TEMPLATE_SIGNATURE
void
DATA_REFERENCE_CLASS::collect_transient_info_base(
...
DATA_REFERENCE_TEMPLATE_SIGNATURE
void
DATA_REFERENCE_CLASS::collect_transient_info(
		persistent_object_manager& m) const {
...
/**
	...
	member_DATA_REFERENCE_CLASS::write_object.
 */
DATA_REFERENCE_TEMPLATE_SIGNATURE
void
DATA_REFERENCE_CLASS::write_object_base(
...
DATA_REFERENCE_TEMPLATE_SIGNATURE
void
DATA_REFERENCE_CLASS::write_object(
...
/**
	...
	member_DATA_REFERENCE_CLASS::load_object.
 */
DATA_REFERENCE_TEMPLATE_SIGNATURE
void
DATA_REFERENCE_CLASS::load_object_base(
...
DATA_REFERENCE_TEMPLATE_SIGNATURE
void
DATA_REFERENCE_CLASS::load_object(const persistent_object_manager& m, 
		istream& f) {
...
#endif	// __OBJECT_ART_OBJECT_INST_REF_DATA_TCC__
