/**
	...
	$Id: AST_fwd.hh,v 1.13 2011/03/23 00:36:06 fang Exp $
 */
...
template <class T>
class node_list;			// defined in "AST/node_list.hh"
...
// defined in "HAC/imported_root.hh"
class imported_root;
class imported_root_list;

//-----------------------------------------------------------------------------
// declared in "AST/definition.hh"
class definition;
class prototype;
...
//-----------------------------------------------------------------------------
// declared in "AST/expr.hh"
class inst_ref_expr;		// from "AST/expr_base.hh"
class range;			// from "AST/range.hh"
class range_list;		// from "AST/range_list.hh"
...
//-----------------------------------------------------------------------------
// declared in "AST/parse_context.hh"
class context;
