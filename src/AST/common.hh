/**
	...
	$Id: common.hh,v 1.2 2005/12/13 04:15:06 fang Exp $
	This file was called the following prior to renaming:
	Id: art_parser_base.hh,v 1.26.4.1 2005/12/11 00:45:03 fang Exp
 */
...
#include "lexer/hac_lex.hh"	// for token_position, line_position, ...
#include "util/memory/excl_ptr.hh"	// experimental pointer classes

/**
	Macro for convenient definition of the node::what member function.  
	util::what is defined in "what.hh".
 */
...
class context;		// defined in "AST/parse_context.hh"
