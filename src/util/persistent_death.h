/**
	\file "persistent_death.h"
	Base class interface for persistent, serializable objects.  
	$Id: persistent_death.h,v 1.1.2.1 2005/02/22 03:33:19 fang Exp $
 */

#ifndef	__PERSISTENT_DEATH_H__
#define	__PERSISTENT_DEATH_H__
