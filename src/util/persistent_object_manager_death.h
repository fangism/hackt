/**
	...
	$Id: persistent_object_manager_death.h,v 1.1.2.1 2005/02/22 03:33:19 fang Exp $
 */

#ifndef	__PERSISTENT_OBJECT_MANAGER_DEATH_H__
#define	__PERSISTENT_OBJECT_MANAGER_DEATH_H__

#include "persistent_death.h"

#include "hash_qmap.h"
// #include "sstream.h"			// reduce to forward decl?
#include "memory/pointer_classes.h"	// needed for death
...
#endif	//	__PERSISTENT_OBJECT_MANAGER_DEATH_H__
