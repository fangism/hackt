/**
	\file "util/reference_wrapper.hh"
	...
	Note that this eliminates the need for the the "util/binders.hh"
	header, at least the reference/value binder defined therein.  
	$Id: reference_wrapper.hh,v 1.2 2006/05/06 04:18:58 fang Exp $
 */
