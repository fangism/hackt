...
#include "util/list_vector_fwd.hh"
// #include "util/qmap.hh"
#include "util/nested_iterator.hh"
...
****/
	...
	swap(this_type& l) {
		...
		std::swap(this->current_chunk_size, l.current_chunk_size);
	}
