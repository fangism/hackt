/**
	...
	$Id: multikey_set.h,v 1.1.4.1.4.1 2005/02/14 05:41:40 fang Exp $
 */
...
public:
	...
	const key_type&
	self_key(void) const { return parent_type::key; }

	const index_type&
	operator [] (const size_t i) const { return parent_type::key[i]; }
