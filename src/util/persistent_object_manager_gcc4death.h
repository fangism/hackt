/**
	\file "persistent_object_manager_gcc4death.h"
	Clases related to serial, persistent object management.  
	$Id: persistent_object_manager_gcc4death.h,v 1.1.2.1 2005/02/14 07:56:33 fang Exp $
 */

#ifndef	__UTIL_PERSISTENT_OBJECT_MANAGER_GCC4DEATH_H__
#define	__UTIL_PERSISTENT_OBJECT_MANAGER_GCC4DEATH_H__

// #include <string>
// #include <iosfwd>
// #include <vector>
// #include "persistent_gcc4death.h"
...
friend class persistent_object_manager;		// need for DEATH
#if 0
public:
	typedef	T				type;
private:
...
public:
	 ...
	 */
	explicit
	persistent_traits(const std::string& s);
#endif
...
#endif	//	__UTIL_PERSISTENT_OBJECT_MANAGER_GCC4DEATH_H__
