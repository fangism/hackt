/**
	\file "util/memory/deallocation_policy_fwd.hh"
	Forward declarations of names of deallocation policies.  
	Their definitions appear in "util/memory/deallocation_policy.hh".
	$Id: deallocation_policy_fwd.hh,v 1.6 2011/02/04 02:23:42 fang Exp $
 */
