/**
	\file "util/memory/unique_ptr.hh"
	Library of pointers for explicit memory management.  
	The pointer classes contained herein are all non-counted.  
	For reference-counted classes, see "count_ptr.hh". 

	Initially just copied from ptrs.hh, but needs to be overhauled:
	...
	$Id: unique_ptr.hh,v 1.2 2006/01/22 06:53:44 fang Exp $
 */
