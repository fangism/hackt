/**
	\file "pointer_traits_gcc41death.h"
	Pointer traits and concepts for pointer classes.  

	$Id: pointer_traits_gcc41death.h,v 1.1.2.1 2005/04/26 00:13:12 fang Exp $
 */

#ifndef	__UTIL_MEMORY_POINTER_TRAITS_GCC41DEATH_H__
#define	__UTIL_MEMORY_POINTER_TRAITS_GCC41DEATH_H__
...
//	typedef	not_a_pointer_tag			type;
	typedef	typename T::pointer_category		type;
};
...
#endif	// __UTIL_MEMORY_POINTER_TRAITS_GCC41DEATH_H__
