/**
	\file "lexer/hacflat-lex-options.h"
	...
	$Id: hacflat-lex-options.h,v 1.2 2008/03/21 00:20:15 fang Exp $
 */
...
#ifndef	YY_DECL
#ifdef	YYLEX_PARAM
#define	YY_DECL		int	__hacflat_lex (hacflat_yystype& hacflat_lval, YYLEX_PARAM)
#else
#define	YY_DECL		int	__hacflat_lex (hacflat_yystype& hacflat_lval)
#endif
#endif
...
**/
#define	yylex(x,y)		__hacflat_lex(x, _lexer_state)
#define	hacflat_lex(x,y)	__hacflat_lex(x, _lexer_state)
#else	/* YYBISON_VERSION */
#define	yylex(x,y)		__hacflat_lex(x, _lexer_state)
#define	hacflat_lex(x,y)	__hacflat_lex(x, _lexer_state)
#endif	/* YYBISON_VERSION */
#else	/* ifdef YYLEX_PARAM */
#define	yylex			__hacflat_lex
#define	hacflat_lex		__hacflat_lex
#endif	/* YYLEX_PARAM */
#endif	/* USING_BISON */
